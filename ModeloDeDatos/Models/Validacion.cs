...
namespace ModeloDeDatos.Models
{
    public partial class Validacion
    {
        ...
        public string SemaforoComprobanteBancario { get; set; }
        public string ResultadoComprobanteBancario { get; set; }
        public DateTime? FechaComprobanteBancario { get; set; }
        ...
        public string ResultadoGeoreferencia { get; set; }
        public DateTime? FechaGeoreferencia { get; set; }
